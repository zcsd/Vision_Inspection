...
void CalibratorForm::initialize()
{
...
void CalibratorForm::hsvThreshold()
{
    ...
    cv::inRange(roiRLHSV, Scalar(h-20, s-100, v-100), Scalar(h+20, s+100, v+100), thresholdHSV);
...
void CalibratorForm::getContour()
{
    ...
    for (size_t i = 0; i < contours.size(); i++)
    {
        ...
        if (area > 20000)
        {
            ...
            //cv::drawContours(roiRLFrame, contours, i, Scalar(255, 0, 0), CV_FILLED, 8, hierarchy);
